...
(function($PS) {
  ...
  var render = function (state) {
      ...
      if (state.view instanceof MainMenu) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(NewFile.value);
              ...
              return new Data_Maybe.Just(LoadFile.value);
          }) ])([ Halogen_HTML_Core.text("Review") ]), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.input([  ]), Halogen_HTML_Elements.input([  ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(LoadFile.value);
          }) ])([ Halogen_HTML_Core.text("Create") ]) ]);
      };
      throw new Error("Failed pattern match at Main (line 49, column 3 - line 66, column 10): " + [ state.view.constructor.name ]);
  };
  var initialState = function (v) {
      return {
          puzzles: [  ],
          reviewStack: [  ],
          view: LoadingFile.value
      };
  };
  var handleAction = function (v) {
      if (v instanceof NewFile) {
      ...
      if (v instanceof LoadFile) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
              ...
              $15.view = MainMenu.value;
              return $15;
          });
      };
      throw new Error("Failed pattern match at Main (line 69, column 16 - line 73, column 50): " + [ v.constructor.name ]);
  };
