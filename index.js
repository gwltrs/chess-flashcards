...
(function($PS) {
  ...
  var Data_Maybe = $PS["Data.Maybe"];
  var Types = $PS["Types"];                
  var getPuzzleName = function (state) {
      if (state.view instanceof Types.MainMenu) {
          return state.view.value0;
      };
      return "";
  };
  var getFEN = function (state) {
      if (state.view instanceof Types.MainMenu) {
  ...
  var reducer = function (state) {
      return function (action) {
          if (action instanceof Types.NewFile) {
              return {
          ...
          if (action instanceof Types.UpdatePuzzleName) {
              return {
                  puzzles: state.puzzles,
                  reviewStack: state.reviewStack,
                  view: new Types.MainMenu(action.value0, getFEN(state)),
                  alert: state.alert
              };
          };
          if (action instanceof Types.UpdateFEN) {
              return {
                  puzzles: state.puzzles,
                  reviewStack: state.reviewStack,
                  view: new Types.MainMenu(getPuzzleName(state), action.value0),
                  alert: state.alert
              };
          };
          ...
          if (action instanceof Types.BackToMain) {
              return {
                  puzzles: state.puzzles,
                  reviewStack: state.reviewStack,
                  view: new Types.MainMenu("", ""),
          ...
          if (action instanceof Types.SavePuzzle) {
              return {
                  puzzles: state.puzzles,
                  reviewStack: state.reviewStack,
                  view: new Types.MainMenu("", ""),
          ...
          if (action instanceof Types.CloseAlert) {
              return {
                  puzzles: state.puzzles,
                  reviewStack: state.reviewStack,
                  view: state.view,
          ...
          throw new Error("Failed pattern match at Reducer (line 8, column 3 - line 28, column 32): " + [ action.constructor.name ]);
      };
  };
...
(function($PS) {
  ...
  var render = function (state) {
      var contentDiv = (function () {
          if (state.view instanceof Types.LoadingFile) {
              return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
                  return new Data_Maybe.Just(Types.NewFile.value);
              }) ])([ Halogen_HTML_Core.text("New") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
                  return new Data_Maybe.Just(Types.LoadFile.value);
              }) ])([ Halogen_HTML_Core.text("Load") ]) ]);
          };
          if (state.view instanceof Types.MainMenu) {
              return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
                  return new Data_Maybe.Just(Types.SaveFile.value);
              }) ])([ Halogen_HTML_Core.text("Save") ]), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
                  return new Data_Maybe.Just(Types.Review.value);
              }) ])([ Halogen_HTML_Core.text("Review") ]), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.input([ Halogen_HTML_Events.onValueChange(function (val) {
                  return new Data_Maybe.Just(new Types.UpdatePuzzleName(val));
              }) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Events.onValueChange(function (val) {
                  return new Data_Maybe.Just(new Types.UpdateFEN(val));
              }) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
                  return new Data_Maybe.Just(Types.CreatePuzzle.value);
              }) ])([ Halogen_HTML_Core.text("Create") ]) ]);
          };
          if (state.view instanceof Types.CreatingPuzzle) {
              return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
                  return new Data_Maybe.Just(Types.BackToMain.value);
              }) ])([ Halogen_HTML_Core.text("Back") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
                  return new Data_Maybe.Just(Types.SavePuzzle.value);
              }) ])([ Halogen_HTML_Core.text("Save") ]) ]);
          };
          throw new Error("Failed pattern match at Render (line 17, column 7 - line 40, column 14): " + [ state.view.constructor.name ]);
      })();
      var alertDiv = (function () {
          var $14 = Data_Maybe.isJust(state.alert);
          if ($14) {
              return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
      ...
      return Halogen_HTML_Elements.div_([ contentDiv, alertDiv ]);
  };
