...
(function($PS) {
  ...
  var render = function (state) {
      ...
      if (state.view instanceof MainMenu) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(NewFile.value);
          }) ])([ Halogen_HTML_Core.text("Save") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(LoadFile.value);
          }) ])([ Halogen_HTML_Core.text("Review") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(LoadFile.value);
          }) ])([ Halogen_HTML_Core.text("Create") ]) ]);
      };
      throw new Error("Failed pattern match at Main (line 49, column 3 - line 62, column 10): " + [ state.view.constructor.name ]);
  };
  ...
  var handleAction = function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 65, column 16 - line 69, column 50): " + [ v.constructor.name ]);
  };
